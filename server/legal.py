...
<link rel="icon" href="/og.jpg"><link rel="canonical" href="https://finostat.com__PATH__"><meta name="robots" content="index, follow">
...
<p>We do <strong>not</strong> collect payment details on this site (plans are activated manually after you contact us), we do not run advertising trackers or third-party analytics, and we never sell or rent personal data.</p>
...
<li><strong>Desk</strong> and <strong>Pro</strong> are paid subscriptions at the prices shown on the <a href="/#plans">plans section</a>, in Indian rupees, exclusive of GST. At present plans are activated manually after you request an upgrade from the terminal and settle payment with us directly; you will receive an invoice.</li>
<li>Subscriptions run for the period paid for and do not renew automatically until online payment is offered. Cancel any time by email; access continues to the end of the paid period. Refunds: within seven days of a first payment if you have not been able to use the service, otherwise pro rata at our discretion.</li>
