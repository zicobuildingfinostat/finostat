...
def render(user: dict, status: dict, history: list[dict], phone: str = "", notice: str | None = None, health: str | None = None, products: list[str] = ()) -> bytes:
    ...
    if "vip" in products:
        box = ('<div class="status"><small>VIP Indicator · owned</small><b style="font-size:16px">Indian markets buy·sell engine — lifetime</b>'
               '<div class="sub"><a href="/vip-indicator/app">Open the app →</a> &nbsp;·&nbsp; <a href="/vip-indicator/pine">Download the Pine Script</a> for TradingView</div></div>') + box
    if "sovereign" in products:
        box = ('<div class="status"><small>XAU Sovereign · owned</small><b style="font-size:16px">XAU/USD buy·sell engine — lifetime</b>'
               '<div class="sub"><a href="/xau-sovereign/app">Open the app →</a> &nbsp;·&nbsp; <a href="/xau-sovereign/pine">Download the Pine Script</a> for TradingView</div></div>') + box
    if notice:
