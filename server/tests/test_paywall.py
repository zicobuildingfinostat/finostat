...
check("chain has OI / Greeks / 2nd / 3rd order views and premium-chart glyphs", 'id="bl-view"' in open_ and "data-v=\"third\"" in open_ and "class=\"chb\"" in open_ and "['ULTIMA','ultima']" in open_ and "premium (right)" in open_)
