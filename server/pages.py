...
var METRICS=[
  ...
  {id:'struct:NIFTY 50:15m', label:'NIFTY 15m engine score (−1…+1)', strike:false, server:true},
  {id:'structdir:NIFTY 50:15m', label:'NIFTY 15m structure (+1 bull / −1 bear)', strike:false, server:true},
  {id:'struct:BANKNIFTY:15m', label:'BANKNIFTY 15m engine score (−1…+1)', strike:false, server:true},
  {id:'structdir:BANKNIFTY:15m', label:'BANKNIFTY 15m structure (+1 / −1)', strike:false, server:true},
  {id:'structdir:NIFTY 50:1h', label:'NIFTY 1h structure (+1 / −1)', strike:false, server:true},
  {id:'structdir:NIFTY 50:D', label:'NIFTY daily structure (+1 / −1)', strike:false, server:true},
  {id:'scalp:NIFTY 50:5m', label:'NIFTY 5m scalper score (−1…+1)', strike:false, server:true},
  {id:'scalp:BANKNIFTY:5m', label:'BANKNIFTY 5m scalper score (−1…+1)', strike:false, server:true},
  {id:'seller:NIFTY 50:15m', label:'NIFTY 15m sell-premium score (−1…+1)', strike:false, server:true},
  {id:'seller:BANKNIFTY:15m', label:'BANKNIFTY 15m sell-premium score (−1…+1)', strike:false, server:true}
];
